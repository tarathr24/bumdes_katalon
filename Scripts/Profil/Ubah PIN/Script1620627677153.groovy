...
WebUI.callTestCase(findTestCase('Login/Login - Ubah PIN'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Daftar Menu/btn_profil'))

WebUI.click(findTestObject('Object Repository/Profil/Ubah Keamanan/button_ubah_keamanan'))
...
WebUI.click(findTestObject('Object Repository/Profil/Ubah Keamanan/Ubah PIN/button_ok'))
